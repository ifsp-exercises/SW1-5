...
public class UpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ids = id;
		Employee emps = employeeDAO.getEmployeeById(id);
		...
		out.print("<!DOCTYPE html>\r\n" + 
				...
				"\r\n" + 
				"      <form class=\"form\" action=\"/TP-01/UpdateServlet\" method=\"POST\">\r\n" + 
				...
				"          </svg>\r\n" + 
				"\r\n" + 
				"          <select name=\"country\" style=\"background: #25273E;\">"
				+ "<option value=\"Brasil\" selected > "+ emps.getCountry() +" </option>\r\n" + 
